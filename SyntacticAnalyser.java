...
public class SyntacticAnalyser {
    ...
    public static ParseTree parse(List<Token> tokens) throws SyntaxException {
        ...
        if(tokens == null){
            throw new SyntaxException("Emtpy");
        }
        ...
        while (i < tokens.size()) {
            System.out.print("stack: " + stack.peek().fst() + ", " );
            ...
            if (stack.peek().fst().isVariable()) {
                if (stack.peek().fst() == TreeNode.Label.prog && tokens.get(i).getType() == Token.TokenType.PUBLIC) {
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.los, current));
                    stack.addFirst(new Pair(TreeNode.Label.stat, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    TreeNode epsilon = new TreeNode(TreeNode.Label.epsilon, current);
                    current.addChild(epsilon);
                    //stack.add(new Pair(TreeNode.Label.epsilon, current));
                    //System.out.println("Is eps on stack? " + (stack.peek().fst() == TreeNode.Label.epsilon));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.whilestat, current));
                } else if (stack.peek().fst() == TreeNode.Label.stat && tokens.get(i).getType() == Token.TokenType.FOR) {
                    // 3.1 <<stat>> => <<for>>
                	TreeNode current = new TreeNode(TreeNode.Label.stat, stack.peek().snd());
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.forstat, current));
                } else if (stack.peek().fst() == TreeNode.Label.stat && tokens.get(i).getType() == Token.TokenType.IF) {
                    // 3.2 <<stat>> => <<if>>
                	TreeNode current = new TreeNode(TreeNode.Label.stat, stack.peek().snd());
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.ifstat, current));
                } else if (stack.peek().fst() == TreeNode.Label.stat && tokens.get(i).getType() == Token.TokenType.ID) {
                    // 3.3 <<stat>> => <<assign>> ;
                	TreeNode current = new TreeNode(TreeNode.Label.stat, stack.peek().snd());
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.SEMICOLON, current));
                    stack.addFirst(new Pair(TreeNode.Label.assign, current));
                    ...
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.SEMICOLON, current));
                    stack.addFirst(new Pair(TreeNode.Label.decl, current));
                    ...
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.SEMICOLON, current));
                    stack.addFirst(new Pair(TreeNode.Label.print, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.RBRACE, current));
                    stack.addFirst(new Pair(TreeNode.Label.los, current));
                    stack.addFirst(new Pair(Token.TokenType.LBRACE, current));
                    stack.addFirst(new Pair(Token.TokenType.RPAREN, current));
                    stack.addFirst(new Pair(TreeNode.Label.boolexpr, current));
                    stack.addFirst(new Pair(TreeNode.Label.relexpr, current));
                    stack.addFirst(new Pair(Token.TokenType.LPAREN, current));
                    stack.addFirst(new Pair(Token.TokenType.WHILE, current));
                    ...
                    stack.addFirst(new Pair(Token.TokenType.LBRACE,current));
                    stack.addFirst(new Pair(Token.TokenType.RPAREN,current));
                    stack.addFirst(new Pair(TreeNode.Label.forarith,current));
                    stack.addFirst(new Pair(Token.TokenType.SEMICOLON, current));
                    stack.addFirst(new Pair(TreeNode.Label.boolexpr, current));
                    stack.addFirst(new Pair(TreeNode.Label.relexpr, current));
                    stack.addFirst(new Pair(Token.TokenType.SEMICOLON, current));
                    stack.addFirst(new Pair(TreeNode.Label.forstart, current));
                    stack.addFirst(new Pair(Token.TokenType.LPAREN, current));
                    stack.addFirst(new Pair(Token.TokenType.FOR, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.arithexpr, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.elseifstat, current));
                    stack.addFirst(new Pair(Token.TokenType.RBRACE, current));
                    stack.addFirst(new Pair(TreeNode.Label.los, current));
                    stack.addFirst(new Pair(Token.TokenType.LBRACE, current));
                    stack.addFirst(new Pair(Token.TokenType.RPAREN, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.relexpr, current));
                    stack.addFirst(new Pair(Token.TokenType.LPAREN, current));
                    stack.addFirst(new Pair(Token.TokenType.IF, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.los, current));
                    stack.addFirst(new Pair(Token.TokenType.LBRACE, current));
                    stack.addFirst(new Pair(TreeNode.Label.elseorelseif, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.possif, current));
                    stack.addFirst(new Pair(Token.TokenType.ELSE, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.expr, current));
                    stack.addFirst(new Pair(Token.TokenType.ASSIGN, current));
                    stack.addFirst(new Pair(Token.TokenType.ID, current));
                	...
                	stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.possassign, current));
                    stack.addFirst(new Pair(Token.TokenType.ID, current));
                    stack.addFirst(new Pair(TreeNode.Label.type, current));
                    ...
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.RPAREN, current));
                    stack.addFirst(new Pair(TreeNode.Label.printexpr, current));
                    stack.addFirst(new Pair(Token.TokenType.LPAREN, current));
                    stack.addFirst(new Pair(Token.TokenType.PRINT, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.TYPE, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.charexpr, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.SQUOTE, current));
                    stack.addFirst(new Pair(Token.TokenType.CHARLIT, current));
                    stack.addFirst(new Pair(Token.TokenType.SQUOTE, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.boolexpr, current));
                    stack.addFirst(new Pair(TreeNode.Label.relexpr, current));
                    stack.addFirst(new Pair(TreeNode.Label.boolop, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.booleq, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.boollog, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.EQUAL, current));
                } else if (stack.peek().fst() == TreeNode.Label.booleq && tokens.get(i).getType() == Token.TokenType.NEQUAL) {
                    //21.1 <<bool eq>> → !=
                    TreeNode current = new TreeNode(TreeNode.Label.booleq, stack.peek().snd());
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.NEQUAL,current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.AND, current));
                } else if (stack.peek().fst() == TreeNode.Label.boollog && tokens.get(i).getType() == Token.TokenType.OR) {
                    //22.1 <<bool log>> → ||
                    TreeNode current = new TreeNode(TreeNode.Label.boollog, stack.peek().snd());
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.OR, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.relexprprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.arithexpr, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.TRUE, current));
                } else if (stack.peek().fst() == TreeNode.Label.relexpr && tokens.get(i).getType() == Token.TokenType.FALSE) {
                    //23.2 <<rel expr>> → false
                    TreeNode current = new TreeNode(TreeNode.Label.relexpr, stack.peek().snd());
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.FALSE, current));
                    ...
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.arithexpr, current));
                    stack.addFirst(new Pair(TreeNode.Label.relop, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.arithexprprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.term, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.arithexprprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.term, current));
                    stack.addFirst(new Pair(Token.TokenType.PLUS, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.arithexprprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.term, current));
                    stack.addFirst(new Pair(Token.TokenType.MINUS, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(TreeNode.Label.termprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.factor, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.termprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.factor, current));
                    stack.addFirst(new Pair(Token.TokenType.TIMES,current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.termprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.factor, current));
                    stack.addFirst(new Pair(Token.TokenType.DIVIDE, current));
                    ...
                    stack.addFirst(new Pair(TreeNode.Label.termprime, current));
                    stack.addFirst(new Pair(TreeNode.Label.factor, current));
                    stack.addFirst(new Pair(Token.TokenType.MOD, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.NUM, current));
                    ...
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    stack.addFirst(new Pair(Token.TokenType.DQUOTE, current));
                    stack.addFirst(new Pair(Token.TokenType.STRINGLIT, current));
                    stack.addFirst(new Pair(Token.TokenType.DQUOTE, current));
                }  else{
                ...
                if(tokens.get(i).getType() == stack.peek().fst()){
                    System.out.println("pop " + tokens.get(i).getType());
                    TreeNode current = new TreeNode(TreeNode.Label.terminal, tokens.get(i), stack.peek().snd());
                    stack.peek().snd().addChild(current);
                    stack.pop();
                    i++;

                } else{
                  throw new SyntaxException("Not match");
                }
